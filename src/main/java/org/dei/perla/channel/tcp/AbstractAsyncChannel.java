...
import org.dei.perla.core.channel.IOTaskCancelledException;
...
public abstract class AbstractAsyncChannel implements Channel{
	...
	public AbstractAsyncChannel(String id) {
		this.id = id;
	 ...
	 */
	public abstract void handleRequest(IORequest request, IOHandler handler) throws ChannelException, InterruptedException;
